...
<form name="updatePurchase" method="post"	action="/purchase/updatePurchase?tranNo=<%=Integer.parseInt(request.getParameter("tranNo"))%>">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="buyerId" value="user11">
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
