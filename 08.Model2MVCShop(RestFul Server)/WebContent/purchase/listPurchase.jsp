...
<c:forEach var="i" items="${list}">
				...
				<tr class="ct_list_pop">
					...
					배송중
					<a href="/purchase/updateTranCode?tranNo=${i.tranNo}&tranCode=3&menu=user">수취확인
					</c:if> 
					<c:if test="${i.tranCode=='3  ' }">
					배송완료 <a href="/purchase/updateTranCode?tranNo=${i.tranNo}&tranCode=4&menu=user">주문취소</a>
					</c:if>
